...
\usepackage{tabularx}
\usepackage{ragged2e}
\usepackage[top=35truemm,bottom=30truemm,left=18truemm,right=18truemm]{geometry}
\usepackage{multirow}
\usepackage{gensymb}
\usepackage{textcomp}
% end of inclusion
...
\begin{titletabular}
\begin{tabularx}{\textwidth}{|wc{37mm}|X|}\hline
\parbox[c][12.5mm][c]{0pt}{}実験テーマ & $metadata.table1.theme$ \\ \hline
\parbox[c][12.5mm][c]{0pt}{}担当教員名  & $metadata.table1.teacher$ \\ \hline
\end{tabularx}
\end{titletabular}
...
\begin{titletabular}
  \begin{table}[!h]
    ...
    \hspace{-8pt}
    \begin{tabular}{l}
      \begin{tabularx}{\textwidth}{|wc{37mm}|X|wc{37mm}|X|}\hline
        \parbox[c][12.5mm][c]{0pt}{} 班番号  & $metadata.table2.group_number$ & 出席番号 & $metadata.table2.your_number$ \\
      \end{tabularx}\\

      \begin{tabularx}{\textwidth}{|wc{37mm}|X|}\hline
        \parbox[c][12.5mm][c]{0pt}{}実験者氏名  & $metadata.table2.your_name$ \\ \hline
      \end{tabularx}\\
      
      \begin{tabularx}{\textwidth}{|wc{37mm}|X|}\hline
        \parbox[c][12.5mm][c]{0pt}{}共同実験者氏名  & $metadata.table2.collaborators$ \\ \hline
      \end{tabularx}
    \end{tabular}
  \end{table}
\end{titletabular}
...
\begin{titletabular}
  \begin{tabularx}{\textwidth}{|wc{37mm}|Y|wc{37mm}|Y|}\hline
    \parbox[c][12.5mm][c]{0pt}{} 実験日  & $metadata.table3.experiment_date$ & レポート提出日 & $metadata.table3.reporting_date$ \\ \hline
  \end{tabularx}
\end{titletabular}
